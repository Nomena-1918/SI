...
<body>
    ...
    <div class="contain-table">
        <table border="1">
            <tr>
                <th class="titre" width="100">Type</th>
        ...
        <table>
            ...
            <tr>
                <td class="component" width="100"><?php echo $det['code']; ?></td>
                <td class="component" width="100"><?php echo $det['cpt_num_aux']; ?></td>
                <td class="component" width="365"><?php echo $det['intitule_aux']; ?></td>
            </tr>
            <?php } ?>
        </table>
    </div>
